	...
	task
		...
		.addHelpText(
			...
			[
				...
				"  --task-id waits on --linked-task-id (the prerequisite runs first). The saved",
				"  direction is stable: it is NOT reoriented when a task starts, and finishing",
				"  the waiter never starts the prerequisite. On the board the arrow points in",
				"  execution order, from the prerequisite (--linked-task-id) into the waiting",
				"  task (--task-id).",
